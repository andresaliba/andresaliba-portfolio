    ...
    <div>
      <div className="flex h-screen justify-center items-center text-white">
        <div className="text-center space-x-3">
          <p className="text-xl py-5">Under construction...🏗</p>
          <button className="bg-gray-700 p-2  rounded" aria-label="github">
          ...
          <button className="bg-blue-600 p-2  rounded" aria-label="linkedin">
            <a
          ...
          <button className="bg-slate-200 p-2 rounded" aria-label="gmail">
